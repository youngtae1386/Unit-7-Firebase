...
$('#addTrainBtn').on("click", function () {
  ...
  if (trainName === "" || destination === "" || firstTrain === "" || frequency === "") {
    alert("Please input a Value in missing Field(s): Train Name, Destination, First Train Time, Frequency" );
    return false;
  }
...
database.ref().on("child_added", function (childSnapshot) {
  ...
  // store difference between currentTime and fist train converted in a variable.
